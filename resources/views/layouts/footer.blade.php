<footer class=footer>
    <div class="footer_main section">
        <div class="container d-flex flex-column flex-md-row flex-wrap flex-xl-nowrap justify-content-xl-between">
            <div class="footer_main-about footer_main-block col-md-6 col-xl-auto"><a
                    class="brand footer_main-about_brand d-flex align-items-center" href=index.html><span
                        class=logo><svg width=48 height=45 viewBox="0 0 48 45" fill=none
                        ...
                        </svg> </span><span class=accent>Health</span> <span>Pred</span></a>
                <div class=footer_main-about_wrapper>
                    <p class=text>Receive accurate predictions for diseases like Kidney Stones, Diabetes, and more. Empower yourself with personalized insights based on your health data. Discover proactive tools to manage your well-being effectively.</p>
                </div>
            </div>
            <div class="footer_main-about footer_main-block col-md-6 col-xl-auto">
                <h4 class="accent">About The Team</h4>
                <div class="footer_main-about_wrapper">
                    <p class="text"><span class="accent">CodeHarbour</span> is a dynamic team of innovative developers and tech enthusiasts dedicated to creating impactful software solutions. With a focus on quality and precision, CodeHarbour excels in developing applications that address real-world problems, leveraging the latest technologies and best practices to deliver exceptional results.</p>
                </div>
            </div>
            <div class="footer_main-nav footer_main-block col-md-6 col-xl-auto">
                <h4 class="footer_main-nav_header footer_main-header">Products</h4>
                <ul class="footer_main-nav_list d-flex flex-wrap flex-md-column">
                    <li class=list-item><a class="link d-inline-flex align-items-center" href="{{url('/kidney-stone/predictor')}}"><i
                                class="icon-caret_right accent icon"></i> Kidney Stone</a></li>
                    <li class=list-item><a class="link d-inline-flex align-items-center" href="{{url('/liver-disease/predictor')}}"><i
                                class="icon-caret_right accent icon"></i> Liver Disease</a></li>
                    <li class=list-item><a class="link d-inline-flex align-items-center" href="{{url('/stroke/predictor')}}"><i
                                class="icon-caret_right accent icon"></i> Stroke</a></li>
                    <li class=list-item><a class="link d-inline-flex align-items-center" href="{{url('/hypertension-disease/predictor')}}"><i
                                class="icon-caret_right accent icon"></i> Hypertension</a></li>
                    <li class=list-item><a class="link d-inline-flex align-items-center" href="{{url('/heart-disease/predictor')}}"><i
                                class="icon-caret_right accent icon"></i> Heart Disease</a></li>
                    
                </ul>
            </div>
            <div class="footer_main-instagram footer_main-block col-md-6 col-xl-auto">
                <h4 class="footer_main-instagram_header footer_main-header">Media</h4>
                <ul class="footer_main-instagram_list d-grid">
                    <li class=list-item><a class=link href=# target=_blank rel="noopener norefferer">
                            <picture>
                                <source data-srcset=https://healthpred.anuragseervi.com/public/img/footer/01.jpg srcset=https://healthpred.anuragseervi.com/public/img/footer/01.jpg type=image/jpg>
                                <img class="lazy preview" data-src=https://healthpred.anuragseervi.com/public/img/footer/01.jpg src=https://healthpred.anuragseervi.com/public/img/footer/01.jpg
                                    alt="instagram post">
                            </picture>
                        </a></li>
                    <li class=list-item><a class=link href=# target=_blank rel="noopener norefferer">
                            <picture>
                                <source data-srcset=https://healthpred.anuragseervi.com/public/img/footer/02.jpg srcset=https://healthpred.anuragseervi.com/public/img/footer/02.jpg type=image/jpg>
                                <img class="lazy preview" data-src=https://healthpred.anuragseervi.com/public/img/footer/02.jpg src=https://healthpred.anuragseervi.com/public/img/footer/02.jpg
                                    alt="instagram post">
                            </picture>
                        </a></li>
                    <li class=list-item><a class=link href=# target=_blank rel="noopener norefferer">
                            <picture>
                                <source data-srcset=https://healthpred.anuragseervi.com/public/img/footer/03.jpg srcset=https://healthpred.anuragseervi.com/public/img/footer/03.jpg type=image/jpg>
                                <img class="lazy preview" data-src=https://healthpred.anuragseervi.com/public/img/footer/03.jpg src=https://healthpred.anuragseervi.com/public/img/footer/03.jpg
                                    alt="instagram post">
                            </picture>
                        </a></li>
                    <li class=list-item><a class=link href=# target=_blank rel="noopener norefferer">
                            <picture>
                                <source data-srcset=https://healthpred.anuragseervi.com/public/img/footer/04.jpg srcset=https://healthpred.anuragseervi.com/public/img/footer/04.jpg type=image/jpg>
                                <img class="lazy preview" data-src=https://healthpred.anuragseervi.com/public/img/footer/04.jpg src=https://healthpred.anuragseervi.com/public/img/footer/04.jpg
                                    alt="instagram post">
                            </picture>
                        </a></li>
                    <li class=list-item><a class=link href=# target=_blank rel="noopener norefferer">
                            <picture>
                                <source data-srcset=https://healthpred.anuragseervi.com/public/img/footer/05.jpg srcset=https://healthpred.anuragseervi.com/public/img/footer/05.jpg type=image/jpg>
                                <img class="lazy preview" data-src=https://healthpred.anuragseervi.com/public/img/footer/05.jpg src=https://healthpred.anuragseervi.com/public/img/footer/05.jpg
                                    alt="instagram post">
                            </picture>
                        </a></li>
                    <li class=list-item><a class=link href=# target=_blank rel="noopener norefferer">
                            <picture>
                                <source data-srcset=https://healthpred.anuragseervi.com/public/img/footer/06.jpg srcset=https://healthpred.anuragseervi.com/public/img/footer/06.jpg type=image/jpg>
                                <img class="lazy preview" data-src=https://healthpred.anuragseervi.com/public/img/footer/06.jpg src=https://healthpred.anuragseervi.com/public/img/footer/06.jpg
                                    alt="instagram post">
                            </picture>
                        </a></li>
                </ul>
