...
<header class="header d-flex flex-wrap align-items-center" data-page=home data-overlay=true>
    <div class="container d-flex flex-wrap flex-xl-nowrap align-items-center justify-content-between"><a
            class="brand header_logo d-flex align-items-center" href="{{url('/')}}"><span class=logo><svg width=48 height=45
                ...
                <nav class="header_nav">
                    ...
                    <!--        <a class="nav-link dropdown-toggle d-inline-flex align-items-center" href="{{url('/team')}}" >Team</a>-->
                    <!--    </li>-->
                    <!--</ul>-->
                    <a class="home" href="{{url('/')}}">Home</a>
                    <a href="{{url('/team')}}">Team</a>
                </nav>
        <span class="header_trigger d-inline-flex d-xl-none flex-column justify-content-between"><span class="line line--short"></span> <span class="line line"></span> <span class="line line--short"></span>
